...
def test_dipole_corrector():
    ...
    FM = make_dipole_corrector_fieldmesh(xmin=-R, xmax=R, nx=11,
                                         ymin=-R, ymax=R, ny=11,
                                         zmin=-5*L/2, zmax=5*L/2, nz=11,
                                         mode='saddle',
    ...
    with tempfile.NamedTemporaryFile(delete=False) as temp_file:
        ...
        FM2 = FieldMesh.from_impact_emfield_cartesian(temp_filename, eleAnchorPt=FM.attrs['eleAnchorPt'])
