...
# The data files (end.par.h5, one4one.par.h5) are committed to the repository.
# They can be regenerated by running Genesis4 on the inputs in
# docs/examples/data/genesis4/ via run.sh.
...
def test_slices_selection(parfile: str):
    ...
    one = genesis4_par_to_data(parfile, slices=[3])
